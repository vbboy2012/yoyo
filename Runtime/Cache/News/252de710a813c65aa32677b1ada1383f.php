...
<div class="container-fluid topp-box clearfloat">
    <div class="col-xs-2 box">
        <div class="img-wrap" style="padding-top: 5px">
...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <link type="text/css" rel="stylesheet" href="/yoyo/Application/News/Static/css/news.css"/>
    ...
    <?php if($data['cover'] != 0): ?><div class="col-xs-4">
        ...
        <div class="col-xs-4">
            <a title="<?php echo (text($data["title"])); ?>" href="<?php echo U('News/index/detail',array('id'=>$data['id']));?>" target="_blank">
                <img alt="暂无封面" src="/yoyo/Application/News/Static/images/nopicture.jpg" style="width: 200px;height: 146px">
            </a>
        </div>
        <div class="col-xs-8">
            <div>

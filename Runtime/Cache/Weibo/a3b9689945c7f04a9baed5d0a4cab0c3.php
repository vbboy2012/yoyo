<?php if (!defined('THINK_PATH')) exit(); $uid=is_login(); ?>
<div class="weibo_post_box">
            <p class="comment-area">
                ...
                <a style="margin-right: 10px"  class=""  <?php if(!$uid): ?>href="javascript:toast.error('请先登入！');"
                <?php else: ?>
                onclick="insertFace($(this))"<?php endif; ?>><i style="color: #999;" class="os-icon-emoticon-smile"></i> </a>

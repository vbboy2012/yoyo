...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div id="body-container" class="container">
        <div class="fmBox sendBox">
            <p class="sendTit">
                <?php if($isEdit): echo L('_POST_EDIT_');?><sub><?php echo L('_POST_PUBLISH_KNOWLEDGE_CONTENT_');?></sub>
                    <?php else: ?>
                    <?php echo L('_POST_PUBLISH_');?><sub><?php echo L('_POST_PUBLISH_KNOWLEDGE_CONTENT_');?></sub><?php endif; ?>
            </p>
            <section id="contents">
                <form action="<?php echo U('Forum/Index/doEdit');?>" method="post" id="edit-article-form" >
                    ...
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <div class="col-xs-9">
                            <input id="title" type="text" name="title" placeholder="<?php echo L('_TITLE_');?>" value="<?php echo ($post["title"]); ?>" class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="upFile" data-role="upFileForum" style="display: none">
                        ...
                        <select name="select_pay">
                            <?php if(is_array($score_type)): $i = 0; $__LIST__ = $score_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
...
<script src="/yoyo/Public/js/socket.io.js"></script>
    ...
    <script type="text/javascript" src="/yoyo/Public/Core/js/ext/atwho/atwho.js"></script>
    <link type="text/css" rel="stylesheet" href="/yoyo/Public/Core/js/ext/atwho//atwho.css"/>
    <script>

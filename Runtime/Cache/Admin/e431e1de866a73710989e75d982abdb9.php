...
<script>
    $('[data-role="addTo"]').click(function () {
        ...
        <div class="main-title pull-left">
            <h2 style="border-bottom: 0;">
                <?php echo L("_MODULE_MANAGEMENT_"); echo L("_ONLY_THE_MODULE_IN_THE_CLOUD_MARKET_CAN_DETECT_UPDATES_");?></h2>
        </div>
        <div class="pull-right">
            ...
            &nbsp;<a
                href="<?php echo U('Module/lists',array_merge($_GET,array('refresh'=>1)));?>" class="btn btn-danger"><i
                class="icon-undo"></i>
    ...
    <div class="tabbable-custom" >
        <ul class="nav nav-tabs group_nav">
            ...
            <li id="type_uninstalled"><a href="<?php echo U('lists',array('type'=>'uninstalled'));?>"><?php echo L("_NOT_INSTALLED_");?></a>
            </li>
        ...
        <div class="tab-content" style="padding-top: 0">
            <ul class="mdUl">
                    <?php if(is_array($modules)): $i = 0; $__LIST__ = $modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="">
                            ...
                            <div class="content-info">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <?php if(empty($vo["update_list"])): else: ?>
                                            <a style="text-decoration: none" href="javascript:void(0)"
                                               data-role="update_btn"
                                               data-type="ajax"
                                               data-url="<?php echo U('Cloud/getVersionList',array('token'=>$vo['token']));?>"
                                               data-toggle="modal"
                                               data-title=<?php echo L("_A_NEW_VERSION_CAN_BE_UPDATED_WITH_DOUBLE_");?>><span
                                                    class=" label label-success "><?php echo L("_THERE_IS_A_NEW_VERSION_"); echo ($vo["update_list"]["0"]["title"]); ?></span></a>
                                            <script>$(function () {
                                ...
                                <div><?php echo L("_DEVELOPER_"); echo L('_COLON_');?> <a style="color: #666"><?php echo ($vo["developer"]); ?></a></div>

...
<div class="wrapper">
    ...
    <div class="tab-wrap with-padding">
        ...
        <div class="block">
            ...
            <ul class="module-list" style="margin-left: 5px">
                <?php if(empty($to_pro)): ?>当前无可升级版本<?php endif; ?>
                <?php if(is_array($to_pro)): $i = 0; $__LIST__ = $to_pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?><li class="clearfix">
                        <div class="cover-wrapper">
                                <div class="cover-icon">
                                    <i class="fa-<?php echo ($v1["now"]["icon"]); ?>"></i>
                                </div>
                        </div>
                        <div class="content-wrapper" style="margin-left: 0!important;background-color: transparent!important;">
                            <div class="title">
                                <a href=""><?php echo ($v1["now"]["alias"]); ?> <span class="text-muted"><?php echo ($v1["now"]["name"]); ?></span></a>
                            </div>
                            <div>
                                <p class="text-muted text-ellipsis"></p>
                            </div>

                            <div class="clearfix bottom-btns">
                            <div class="pull-left">
                                <div>开源版 <?php echo ($v1["now"]["version"]); ?> </div>
                            </div>
                            <div class="pull-right">
                                    <a  href="<?php echo U('update',array('name'=>$v1['now']['name']));?>" class="btn btn-info btn-large">升级至Pro版<br><?php echo ($v1["new"]["title"]); ?></a>
                            </div>
                        </div>
                        </div>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="block">
            ...
            <ul class="module-list" style="margin-left: 5px">
                <?php if(empty($to_new)): ?>当前无可升级版本<?php endif; ?>

                <?php if(is_array($to_new)): $i = 0; $__LIST__ = $to_new;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?><li class="clearfix">
                        <div class="cover-wrapper">
                            <div class="cover-icon">
                                <i class="fa-<?php echo ($v2["now"]["icon"]); ?>"></i>
                            </div>
                        </div>
                        <div class="content-wrapper" style="margin-left: 0!important;background-color: transparent!important;">
                            <div class="title">
                                <a href=""><?php echo ($v2["now"]["alias"]); ?> <span class="text-muted"><?php echo ($v2["now"]["name"]); ?></span></a>
                            </div>
                            <div>
                                <p class="text-muted text-ellipsis"></p>
                            </div>
                            ...
                            <div class="clearfix bottom-btns">
                                <div class="pull-left">
                                    <div>Pro版 <?php echo ($v2["now"]["version"]); ?> </div>
                                </div>
                                <div class="pull-right">
                                    <a  href="<?php echo U('update',array('name'=>$v2['now']['name']));?>" class="btn btn-info btn-large">升级至Pro版<br><?php echo ($v2["new"]["title"]); ?></a>
                                </div>
                            </div>
                        </div>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="block">
            ...
            <ul class="module-list" style="margin-left: 5px">
                <?php if(empty($other)): ?>当前无可升级版本<?php endif; ?>

                <?php if(is_array($other)): $i = 0; $__LIST__ = $other;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v3): $mod = ($i % 2 );++$i;?><li class="clearfix">
                        <div class="cover-wrapper">
                            <div class="cover-icon">
                                <img src="<?php echo ($v3["cover_path"]); ?>">
                            </div>
                        </div>
                        <div class="content-wrapper" style="margin-left: 0!important;background-color: transparent!important;">
                            <div class="title">
                                <a href=""><?php echo ($v3["title"]); ?> <span class="text-muted"><?php echo ($v3["etitle"]); ?></span></a>
                            </div>
                            <div>
                                <p class="text-muted text-ellipsis"></p>
                            </div>
                            ...
                            <div class="clearfix bottom-btns">
                                <div class="pull-left">
                                    <div>Pro版 <?php echo ($v3["latest_version"]); ?> </div>
                                </div>
                                <div class="pull-right">
                                    <a  href="<?php echo U('update',array('name'=>$v3['etitle']));?>" class="btn btn-info btn-large">     安装     <br><?php echo ($v3["latest_version"]); ?> Pro</a>
                                </div>
                            </div>
                        </div>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>

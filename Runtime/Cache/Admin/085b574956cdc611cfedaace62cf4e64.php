        ...
        <div class="col-md-6 col-sm-6">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-5">
                            <a target="_blank" href="http://zhiguo.opensns.cn"><img src="/yoyo/Application/Admin/Static/images/zhiguo.png"></a>
                        </div>
                        <div  class="col-md-7">
                            <div class="">
...
//        nav_obj.trigger("click");
    ...
    <script src="/yoyo/Application/Admin/Static/bootstrap/plugins/counterup/jquery.waypoints.min.js" type="text/javascript"></script>
    <script src="/yoyo/Application/Admin/Static/bootstrap/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
    <link href="/yoyo/Application/Admin/Static/bootstrap/plugins/metro/MetroJs.min.css" type="text/css" rel="stylesheet">
    <script src="/yoyo/Application/Admin/Static/bootstrap/plugins/metro/MetroJs.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="/yoyo/Application/Admin/Static/js/highcharts.js"></script>
    <script type="text/javascript" src="/yoyo/Application/Admin/Static/adminlte/plugins/jQueryUI/jquery-ui.min.js"></script>

    <script src="/yoyo/Application/Admin/Static/js/jquery.simple-color.js"></script>
    <link rel="stylesheet" href="/yoyo/Application/Admin/Static/css/tile.css" media="all">

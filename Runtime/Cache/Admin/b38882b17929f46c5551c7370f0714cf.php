		...
		<div class="search-form col-md-offset-10 col-xs-2 ">
			<div class="input-group">
				<input type="text" name="nickname" class="search-input form-control" value="<?php echo I('nickname');?>" placeholder=<?php echo L("_PLEASE_ENTER_A_USER_NAME_OR_ID_WITH_DOUBLE_");?>>
				                   <span class="input-group-btn"><a class="btn btn-default" href="javascript:;" id="search" url="<?php echo U('userList');?>"><i class="fa fa-search"></i></a></span>
			</div>
		</div>
    </div>
    <!-- 数据列表 -->
...
//        nav_obj.trigger("click");
	...
	<script src="/yoyo/Public/static/thinkbox/jquery.thinkbox.js"></script>

                                ...
                                <?php if(is_array($people1)): $i = 0; $__LIST__ = $people1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                                        <div>
                                            <div><a href="<?php echo ($v["user"]["space_url"]); ?>">
                                                <?php if($v['user']['avatar64'] == $v['user']['avatar32']): ?><img class="avatar-img" src="<?php echo ($v["user"]["avatar64"]); ?>" style="width: 64px;height:64px;">
                                                <?php else: ?>
                                                <img class="avatar-img" src="<?php echo ($v["user"]["avatar64"]); ?>"><?php endif; ?>
                                            </a>
                                            </div>
                                            <div class="user-name">

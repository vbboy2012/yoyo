...
<!--顶部导航之后的钩子，调用公告等 end-->
                ...
                <div style="padding: 0 10px;width: 100%;float: left;">
                    <form class="form-horizontal ajax-form" action="<?php echo U('Coin/Index/doPost');?>" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <label> <input name="coin_type" value="1" type="radio"/>BTC</label>
                                <label class="ad_magrain40"> <input name="coin_type" value="2" type="radio"/>ETH</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <label> <input name="type" value="1" type="radio"/><?php echo L('_AD_ONLINE_SELL_');?></label>
                                <label class="ad_magrain40"> <input name="type" value="2" type="radio"/><?php echo L('_AD_ONLINE_BUY_');?></label>
                                <label class="ad_magrain40"> <input name="type" value="3" type="radio"/><?php echo L('_AD_LOCAL_SELL_');?></label>
                                <label class="ad_magrain40"> <input name="type" value="4" type="radio"/><?php echo L('_AD_LOCAL_BUY_');?></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <div class="input-group input-group-lg">
                                    <input type="text" class="form-control form_check" name="pre_price" check-type="IntNum">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <div class="input-group input-group-lg">
                                    <input type="text" class="form-control" name="price" onfocus=this.blur()>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <div class="input-group input-group-lg" style="width: 100%">
                                    <input type="text" class="form-control" name="pay_addr">
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-xs-2" style="margin-top: 10px">
                                <label><?php echo L('_AD_LOW_PRICE_LABEL_');?></label>
                            </div>
                            <div class="col-xs-6">
                                <div class="input-group input-group-lg">
                                    <input type="text" class="form-control form_check" name="low_price" check-type="IntNum" can-empty="1">
                                    <span class="input-group-addon">CNY</span>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <div class="input-group input-group-lg">
                                    <input type="text" class="form-control form_check" name="max_price" check-type="IntNum">
                                    <span class="input-group-addon">CNY</span>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <div class="input-group input-group-lg">
                                    <input type="text" class="form-control form_check" name="pay_time" check-type="IntNum">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <textarea name="pay_text" class="text form-control" placeholder="<?php echo L('_AD_PAY_TEXT_TIPS_LABEL_');?>" style="height: 8em;height: 160px"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="collapse" id="collapseExample">
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    <textarea name="auto_mesage" class="text input-large form-control" style="height: 8em;height: 100px"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    <label> <input name="is_safe" value="1" type="radio"/><?php echo L('_AD_OPEN_');?></label>&nbsp;&nbsp;&nbsp;
                                    <label class=""> <input name="is_safe" value="0" type="radio" checked/><?php echo L('_AD_CLOSE_');?></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    <label> <input name="is_trust" value="1" type="radio"/><?php echo L('_AD_OPEN_');?></label>&nbsp;&nbsp;&nbsp;
                                    <label class=""> <input name="is_trust" value="0" type="radio" checked/><?php echo L('_AD_CLOSE_');?></label>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="start_time1" class="form-control">
                                            ...
                                            <?php if(is_array($time)): $i = 0; $__LIST__ = $time;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$top): $mod = ($i % 2 );++$i;?><option value="<?php echo ($top["time"]); ?>" >
                                                    <?php echo ($top["time"]); ?>
                                                </option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
    ...
    <link href="/yoyo/Application/Coin/Static/css/form_check.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="/yoyo/Application/Coin/Static/js/form_check.js"></script>
    ...
    <script>
        $("input[name='pre_price']").blur(function () {
            ...
            var marketPrice = <?php echo ($marketPrice); ?>;
            var price = prePrice/100*marketPrice+marketPrice;

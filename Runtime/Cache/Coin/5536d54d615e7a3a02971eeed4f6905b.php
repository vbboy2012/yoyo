...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div class="common_block_title_right" style="text-align: center;">
        <?php $img = substr($tradead['path'],0,strlen($tradead['path'])-4);$img.='_64_64'; ?>
        <div><a href=""><img src="/yoyo/Uploads/Avatar/<?php echo ($img); ?>.jpg" class="img-circle" style="padding-right: 10px"></a></div>

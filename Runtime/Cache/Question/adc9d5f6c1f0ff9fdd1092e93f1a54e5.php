...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <link type="text/css" rel="stylesheet" href="/yoyo/Application/Question/Static/css/question.css"/>
    <div class="container" style="min-height: 400px">
        <div class="row">
            <div class="col-xs-12">
                <div class="questions">
                    <div class="common_block_border margin-bottom-15">
                        <?php if(empty($topic_id)): ?><div class="tags" style="padding: 15px;">
                            ...
                            <div class="tags" style="padding: 15px;">
                                <a href="#" <?php if(!$topic_cate): ?>class="active"<?php endif; ?>>
                                热门话题:
                                </a>
                                <?php if(is_array($hot_topic)): $i = 0; $__LIST__ = $hot_topic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Question/Index/questions',array('topic'=>$type['id']));?>" data-id="<?php echo ($type['id']); ?>" class="ptype <?php if($topic_cate == $type['id']): ?>active<?php endif; ?>">
                                    <?php echo ($type["title"]); ?>
                                    </a><?php endforeach; endif; else: echo "" ;endif; ?>
                            </div><?php endif; ?>
                ...
                <div class="common_block_border clearfix">
                    <div class="question_list" style="padding:0 20px">
                        <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="one_question clearfix">
    <div class="clearfix">
        <div class="pull-left">

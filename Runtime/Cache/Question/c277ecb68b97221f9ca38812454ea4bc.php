...
<script src="/yoyo/Public/js.php?f=js/jquery-2.0.3.min.js,js/com/com.functions.js,static/os-loading/loading.js,js/core.js,js/com/com.toast.class.js,js/com/com.ucard.js"></script>
    ...
    <link href="/yoyo/Application/Question/Static/css/question.css" rel="stylesheet" type="text/css"/>
    <link href="/yoyo/Application/Question/Static/css/jquery.tagsinput.css" rel="stylesheet" type="text/css"/>
...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div class="col-xs-12">
        <div id="frm-post-popup" class="white-popup1 boxShadowBorder col-xs-9">
            <h2><?php echo ($edit_title); ?></h2>

            <div class="aline" style="margin-bottom: 10px"></div>
            <div class="row">
                <div class="col-xs-12">
                    <form class="form-horizontal ajax-form" id="form" role="form" action="<?php echo U('Question/Index/edit');?>"
                          method="post">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-xs-8">
                                <input id="title" name="title" class="form-control form_check" check-type="Text"
                                       value="<?php echo ($data["title"]); ?>" placeholder=<?php echo L("_TITLE_WITH_DOUBLE_");?>/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-2">
                                <input class="form-control" placeholder="输入悬赏积分" name="score_num" type="text" />
                            </div>
                            <div class="col-xs-2">
                                <select class="form-control" onchange="showScore(this)">
                                    <option value="">快速选择积分</option>
                        ...
                        <div class="form-group has-feedback">
                            <label for="title" class="col-xs-2 control-label">话题</label>

                            <div class="col-xs-8">
                                <input id="topic"  class="form-control form_check" check-type="Text"
                                       value="<?php echo ($data["topic"]); ?>" placeholder="请输入关键词，用逗号隔开，最多5个哦"/>
                                <input name="topic" type="hidden" data-role="topics">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-xs-1">
                                <button type="submit" class="btn btn-primary "><?php echo L("_SUBMIT_");?>
                                </button>
        ...
        <div class="col-xs-3">
            <div class="boxShadowBorder" style="padding: 10px;font-size: 18px;line-height: 30px;color: #BBB;">
    ...
    <script type="text/javascript" src="/yoyo/Application/Core/Static/js/form_check.js"></script>
    <script type="text/javascript" src="/yoyo/Application/Question/Static/js/jquery.tagsinput.js"></script>
    <script>
        var question = localStorage.getItem('temp_question');
        if (question!= '') {
            $('#title').val(question);
            localStorage.removeItem('temp_question');
        }

        var update_attach_value = function () {
            var tags = $('#topic').getTags();
            $('[data-role="topics"]').val(tags);
        };
        ...
        function showScore(obj){
            var num = obj.value ;
            if(num != ''){
                $('input[name="score_num"]').val(num) ;
            }else{
                $('input[name="score_num"]').val('') ;
            }
        }
    </script>

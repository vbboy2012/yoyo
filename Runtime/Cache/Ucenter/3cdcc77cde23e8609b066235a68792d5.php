...
<nav class="navbar navbar-default uc_navbar" role="navigation">
    ...
    <!-- /.navbar-collapse -->
                ...
                <div class="cont-wrap common-cont-wrap">
                    ...
                    <div class="f-wrap">
                        <?php if(is_array($fans)): $i = 0; $__LIST__ = $fans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fan): $mod = ($i % 2 );++$i;?><div class="row list-item" >
                                <img ucard="<?php echo ($fan["who_follow"]); ?>"  class="avatar-img" src="<?php echo ($fan["user"]["avatar128"]); ?>"/>

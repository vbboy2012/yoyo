...
<nav class="navbar navbar-default uc_navbar" role="navigation">
    ...
    <!-- /.navbar-collapse -->
                ...
                <div class="cont-wrap common-cont-wrap">
                    ...
                    <div class="f-wrap">
                        <?php if(is_array($following)): $i = 0; $__LIST__ = $following;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fan): $mod = ($i % 2 );++$i;?><div class="row list-item">
                                <img ucard="<?php echo ($fan["follow_who"]); ?>" class="avatar-img" src="<?php echo ($fan["user"]["avatar128"]); ?>"/>
                                <div class="f-info pull-left">
                                    <a class="f-name" href="<?php echo ($fan["user"]["space_url"]); ?>"><?php echo ($fan["user"]["nickname"]); ?></a>
                                    <p class="text-more f-sig">
                                        <?php if($fan['user']['signature'] == ''): echo L('_NO_IDEA_');?>
                                            <?php else: ?>
                                            <?php echo ($fan["user"]["signature"]); endif; ?>
                                        </p>
                                    <div class="f-sig">
                                        <span>

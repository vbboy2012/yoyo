...
<div id="uploader-demo">
    ...
    <div class="show_avatar">
        ...
        <div class="col-xs-4 avatar_select" >
            ...
            <input class="btn btn-default avatar_btn y-btn" data-role="avatar_btn"  type="button" value="<?php echo L('_AVATAR_SAVE_');?>"/>
        </div>
...
<link rel="stylesheet" type="text/css" href="/yoyo/Public/static/jcrop/jquery.Jcrop.css"/>
<script src="/yoyo/Public/static/jcrop/jquery.Jcrop.js"></script>
<script src="/yoyo/Public/static/browser/jquery.browser.js"></script>

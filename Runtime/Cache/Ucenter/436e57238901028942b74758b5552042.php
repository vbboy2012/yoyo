    ...
    <div class="id-liberty id-term row">
      ...
      <?php if($attest_type['conditions']['phone'] == 1): ?><div class="term-box">
          ...
          <?php if($phone_ok): ?><div class="condition">
            ...
            <a href="<?php echo U('Ucenter/Config/safe');?>" target="_blank" class="id-btn no">去绑定</a><?php endif; ?>
        </div><?php endif; ?>
      <?php if($attest_type['conditions']['follow'] > 0): ?><div class="term-box">
          ...
          <?php if($follow_ok): ?><div class="condition">
              <i class="iconfont icon-dui"></i>
              <span>信任><?php echo ($attest_type['conditions']['follow']); ?>人</span>
            </div>
            <a href="javascript:" class="id-btn yes">已符合</a>
            <?php else: ?>
            <div class="condition">
            ...
            <a href="<?php echo U('People/Index/index');?>" target="_blank" class="id-btn no">去信任</a><?php endif; ?>
        </div><?php endif; ?>

                    ...
                    <div id="center_account">
                        <div class="row">
                            <div class="col-xs-12">
                                <ul class="nav nav-secondary">
                                    <li class="active"><a href="#tab_1" data-toggle="tab"><?php echo L('_AD_ONLINE_SELL_');?></a></li>
                                    <li><a href="#tab_2" data-toggle="tab"><?php echo L('_AD_ONLINE_BUY_');?></a></li>
                                    <li><a href="#tab_3" data-toggle="tab"><?php echo L('_AD_LOCAL_SELL_');?></a></li>
                                    <li><a href="#tab_4" data-toggle="tab"><?php echo L('_AD_LOCAL_BUY_');?></a></li>
                                </ul>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <?php if(count($list1) == 0): ?><p class="text-muted"
                                                                           style="text-align: center; font-size: 3em;">
                                    <br><br>
                                    <?php echo L('_AD_NONE_'); echo L('_WAVE_');?>
                                    <br><br><br>
                                </p>
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;">地区</th>
                                            <th style="vertical-align: middle;">付款方式</th>
                                        ...
                                        <?php if(is_array($list1)): $i = 0; $__LIST__ = $list1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                <?php $minPrice = number_format($vo['min_price']); $maxPrice = number_format($vo['max_price']); $price = number_format($vo['price'],2); $coinType = $vo['coin_type']==1?'BTC':'ETH'; ?>
                            ...
                            <div class="tab-pane" id="tab_2">
                                <?php if(count($list2) == 0): ?><p class="text-muted"
                                                                      style="text-align: center; font-size: 3em;">
                                    <br><br>
                                    <?php echo L('_AD_NONE_'); echo L('_WAVE_');?>
                                    <br><br><br>
                            ...
                            <div class="tab-pane" id="tab_3">
                                <?php if(count($list3) == 0): ?><p class="text-muted"
                                                                      style="text-align: center; font-size: 3em;">
                                    <br><br>
                                    <?php echo L('_AD_NONE_'); echo L('_WAVE_');?>
                                    <br><br><br>
                            ...
                            <div class="tab-pane" id="tab_4">
                                <?php if(count($list4) == 0): ?><p class="text-muted"
                                                                      style="text-align: center; font-size: 3em;">
                                    <br><br>
                                    <?php echo L('_AD_NONE_'); echo L('_WAVE_');?>
                                    <br><br><br>

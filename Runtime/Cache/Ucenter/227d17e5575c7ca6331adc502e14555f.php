                ...
                <div class="cont-wrap common-cont-wrap">
                    <div class="row">
                        <div class="col-xs-12 uc_fans">
                            <ul class="nav nav-pills ucenter-tab">
                                <li <?php if(($tab) == "rank"): ?>class="active"<?php endif; ?>><a href="<?php echo U('Ucenter/Config/rank',array('uid'=>$user_info['uid']));?>"

                            >
                                <?php echo L('_TANK_OWNED_');?></a></li>
                                <?php if($user_info['uid'] == is_login()): ?><li <?php if(($tab) == "rankVerifyWait"): ?>class="active"<?php endif; ?>><a href="<?php echo U('Ucenter/Config/rankVerifyWait');?>"
                    ...
                    <div style="margin: 20px 0 20px 20px;">
                        <?php if(is_array($rankList)): $i = 0; $__LIST__ = $rankList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><div class="row">
                                ...
                                <div class="col-xs-2">
                                    <?php if(($tab) == "rankVerifyWait"): ?><a class="btn btn-primary" href="<?php echo U('Ucenter/Config/rankVerifyCancel',array('rank_id'=>$rank['rank_id']));?>"><?php echo L('_APPLY_CANCEL_');?></a><?php endif; ?>
                                    <?php if(($tab) == "rankVerifyFailure"): ?><a class="btn btn-primary" href="<?php echo U('Ucenter/Config/rankVerify',array('rank_user_id'=>$rank['id']));?>"><?php echo L('_APPLY_RE_');?></a><?php endif; ?>
                                </div>

<?php if (!defined('THINK_PATH')) exit(); if(($type) == "personal"): ?><div class="form-group">
        ...
        <div class="col-xs-4" >
            <div id="alert_<?php echo ($field_id); ?>" class="alert alert-danger hide" style="margin-bottom: 0;margin-top: 0!important;"><label id="label_<?php echo ($field_id); ?>"></label></div>
        </div>
    </div>
    <?php else: ?>

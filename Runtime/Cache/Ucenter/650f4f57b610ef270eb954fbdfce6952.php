                ...
                <div class="col-xs-10 common-cont-wrap">
                    <table class="table table-striped table-hover">
                        ...
                        <?php if(is_array($adList)): $i = 0; $__LIST__ = $adList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td style="vertical-align: middle;color: #0C7F12"><?php echo ($vo['status']==2?下架:激活); ?></td>
                                <td style="vertical-align: middle;"><a href="/yoyo/ad/advertise/<?php echo ($vo["id"]); ?>" target="_blank">编辑</a><a href="/yoyo/ucenter/index/myad/active/<?php echo ($vo["id"]); ?>/status/<?php echo ($vo["status"]); ?>"><?php echo ($vo['status']==1?激活:下架); ?></a><a class="delete" href="/yoyo/ucenter/index/myad/delete/<?php echo ($vo["id"]); ?>">删除</a></td>

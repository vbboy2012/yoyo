...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <section>
        ...
        <div class="common_block_border login-form-inbox " style="margin-top: 100px">
            <div class="login-text"><strong><h1><?php echo L('_SEND_MAIL_PASSWORD_FOUND_MOBILE_');?></h1></strong></div>
            <form class="login-form" id="J_findpwd_form" action="<?php echo U('Member/miMobile');?>" method="post">

                <div class="control-group login-input">


                    <div class="controls">
                        <input type="text" id="inputEmail" class="form-control" placeholder="<?php echo L('_MI_MOBILE_PLACEHOLDER_');?>"
                ...
                <a class="btn btn-default" href="<?php echo U('Member/mi');?>">邮箱密码找回</a>
                <?php } ?>
...
*/
                ...
                $.post("<?php echo U('Ucenter/verify/sendVerifyFindPsw');?>", {
                    account: account,
                    type: type,
                    action: 'member',
                    verify: verify

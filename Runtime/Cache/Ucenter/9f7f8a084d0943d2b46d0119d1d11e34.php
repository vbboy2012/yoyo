...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div class="alert with-icon alert-info">
        ...
        <div class="content">
            <?php echo L('_ACCOUNT_DEAR_NOT_ACTIVE_1_'); echo ($nickname); ?>
            <?php echo L('_COLON_');?>
            <?php echo L('_ACCOUNT_DEAR_NOT_ACTIVE_2_');?>“<?php echo ($email); ?>”
            <?php echo L('_ACCOUNT_DEAR_NOT_ACTIVE_3_');?>
            <?php echo L('_PERIOD_');?><a href="javascript:" data-role="reSend">
            <?php echo L('_ACCOUNT_DEAR_NOT_ACTIVE_4_');?></a>
            <?php echo L('_ACCOUNT_DEAR_NOT_ACTIVE_5_');?><a
                  data-toggle="modal" data-target="#changeEmail">
            <?php echo L('_ACCOUNT_DEAR_NOT_ACTIVE_6_');?></a>
        </div>
    </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <?php echo L('_ACCOUNT_DEAR_NOT_ACTIVE_6_');?></h4>
                </div>
                <div class="modal-body">

                    <div class="form-horizontal  center_info ">
                        <div class="form-group">
                            <label for="account" class="col-xs-2 control-label"><?php echo L('_PLACEHOLDER_EMAIL_INPUT_');?></label>
                ...
                <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-role="changeEmail"><?php echo L('_SAVE_');?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(function () {
            $('[data-role="reSend"]').click(function () {
                toast.showLoading();
                $.post("<?php echo U('ucenter/member/reSend');?>", {}, function (res) {
                        if(res.status){
            ...
            $('[data-role="changeEmail"]').click(function () {
                ...
                $.post("<?php echo U('ucenter/member/changeEmail');?>", {email:email}, function (res) {
                   handleAjax(res)
                    toast.hideLoading();
                })
            })

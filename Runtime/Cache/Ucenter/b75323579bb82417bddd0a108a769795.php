...
<?php echo hook('pageHeader');?>
    <link href="/yoyo/Application/Ucenter/Static/css/ranklist.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="/yoyo/Application/Ucenter/Static/js/jquery.js"></script>
</head>
<body>
<!-- 头部 -->
...
<body>
    ...
    <div class="container" style="overflow: hidden">
        <div id="page_wrap">
            ...
            <div class="rank-wrap row">
                <div class="col-xs-6 rank-left-box">
                    <!--粉丝排行榜-->
                    <div class="rank-title">
                        <span class="ranking"> 粉丝排行榜 </span>
                        <div class="circle right">
                            <span class="one-rank"><?php echo ($fans_rank); ?></span>
                            <!--<img src="/yoyo/Application/Ucenter/Static/images/silk.png" class="silk ">-->
                        </div>
                    </div>
                    <div class=" rank-box">
                        <div class="rank-cate">
                            ...
                            <span class="right">粉丝数</span>
                        </div>

                        <div id="content_fans" class="rank-list-block">
    <?php if(is_array($user_fans_list)): $i = 0; $__LIST__ = $user_fans_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fans): $mod = ($i % 2 );++$i;?><p class="rank-lists " <?php if(($mod) == "0"): ?>style="background-color: #f5f5f5"<?php endif; if(($mod) == "1"): ?>style="background-color: #fafafa"<?php endif; ?> >
            <?php echo ($fans["ranking"]); ?>
            <span class="nickname"><a href="<?php echo U('Ucenter/Index/index', array('uid' => $fans['uid']));?>" class="face"><img src="<?php echo ($fans["avatar32"]); ?>" class="avatar-img"></a><a href="<?php echo U('Ucenter/Index/index', array('uid' => $fans['uid']));?>"><?php echo ($fans["nickname"]); ?></a></span>
            <span class="value c9"><?php echo ($fans["fans"]); ?></span>
...
<script type="text/javascript">
    ...
    function go_to_page_fans(page_num){
        ...
        $('#current_page_fans').val(page_num);
                    ...
                    <!--连签排行榜-->
                    <div class="rank-title continuity">
                        <span class="ranking"> 连签排行榜 </span>
                        <div class="circle right">
                            <span class="one-rank"><?php echo ($con_check_rank); ?></span>
                            <!--<img src="/yoyo/Application/Ucenter/Static/images/silk.png" class="silk ">-->
                        </div>
                    </div>
                    <div class="rank-box">
                        <div class="rank-cate">
                            <span class="num">排名</span>
                            <span class="nickname">昵称</span>
                            <span class="right">连签天数</span>
                        </div>

                        <div id="content" class="rank-list-block">
    <?php if(is_array($user_list)): $i = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p class="rank-lists " <?php if(($mod) == "0"): ?>style="background-color: #f5f5f5"<?php endif; if(($mod) == "1"): ?>style="background-color: #fafafa"<?php endif; ?> >
            <?php echo ($vo["ranking"]); ?>
            <span class="nickname"><a href="<?php echo U('Ucenter/Index/index', array('uid' => $vo['uid']));?>" class="face"><img src="<?php echo ($vo["avatar32"]); ?>" class="avatar-img"></a><a href="<?php echo U('Ucenter/Index/index', array('uid' => $vo['uid']));?>"><?php echo ($vo["nickname"]); ?></a></span>
            <span class="value c9"><?php echo ($vo["con_check"]); ?></span>
        </p><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
...
<script type="text/javascript">
    ...
    function go_to_page(page_num){
        ...
        $('#current_page').val(page_num);
                ...
                <div class="col-xs-6 rank-right-box">
                    <!--积分排行榜-->
                    <div class="rank-title score">
                        <span class="ranking"> 积分排行榜 </span>
                        <div class="circle right">
                            <span class="one-rank"><?php echo ($score_rank); ?></span>
                            <!--<img src="/yoyo/Application/Ucenter/Static/images/silk.png" class="silk ">-->
                        </div>
                    </div>
                    <div class="rank-box">
                        <div class="rank-cate">
                            <span class="num">排名</span>
                            <span class="nickname">昵称</span>
                            <span class="right">积分值</span>
                        </div>

                        <div id="content_score" class="rank-list-block">
    <?php if(is_array($user_score_list)): $i = 0; $__LIST__ = $user_score_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$score): $mod = ($i % 2 );++$i;?><p class="rank-lists " <?php if(($mod) == "0"): ?>style="background-color: #f5f5f5"<?php endif; if(($mod) == "1"): ?>style="background-color: #fafafa"<?php endif; ?> >
            <?php echo ($score["ranking"]); ?>
            <span class="nickname"><a href="<?php echo U('Ucenter/Index/index', array('uid' => $score['uid']));?>" class="face"><img src="<?php echo ($score["avatar32"]); ?>" class="avatar-img"></a><a href="<?php echo U('Ucenter/Index/index', array('uid' => $score['uid']));?>"><?php echo ($score["nickname"]); ?></a></span>
            <span class="value c9"><?php echo ($score["score1"]); ?></span>
        </p><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
...
<script type="text/javascript">
    ...
    function go_to_page_score(page_num){
        ...
        $('#current_page_score').val(page_num);
                    ...
                    <!--累签排行榜-->
                    <div class="rank-title score total">
                        <span class="ranking"> 累签排行榜 </span>
                        <div class="circle right">
                            <span class="one-rank"><?php echo ($total_check_rank); ?></span>
                            <!--<img src="/yoyo/Application/Ucenter/Static/images/silk.png" class="silk ">-->
                        </div>
                    </div>
                    <div class="rank-box ">
                        <div class="rank-cate">
                            <span class="num">排名</span>
                            <span class="nickname">昵称</span>
                            <span class="right">累签天数</span>
                        </div>

                        <div id="content_total" class="rank-list-block">
    <?php if(is_array($user_total_list)): $i = 0; $__LIST__ = $user_total_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vl): $mod = ($i % 2 );++$i;?><p class="rank-lists " <?php if(($mod) == "0"): ?>style="background-color: #f5f5f5"<?php endif; if(($mod) == "1"): ?>style="background-color: #fafafa"<?php endif; ?> >
            <?php echo ($vl["ranking"]); ?>
            <span class="nickname"><a href="<?php echo U('Ucenter/Index/index', array('uid' => $vl['uid']));?>" class="face"><img src="<?php echo ($vl["avatar32"]); ?>" class="avatar-img"></a><a href="<?php echo U('Ucenter/Index/index', array('uid' => $vl['uid']));?>"><?php echo ($vl["nickname"]); ?></a></span>
            <span class="value c9"><?php echo ($vl["total_check"]); ?></span>
        </p><?php endforeach; endif; else: echo "" ;endif; ?>
</div>

                                    ...
                                    <div class="col-xs-10">
                                        <?php if(is_array($rankList)): $i = 0; $__LIST__ = $rankList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><div class="col-xs-4 text-center">
                                                <label class="radio-inline">
                                                    <attr>
                                                        <p>
                                                            <?php if(empty($rank["label_content"])): ?><img style="width: 18px;" class="rank-icon" src="<?php echo ($rank["logo_url"]); ?>" title="<?php echo ($rank["title"]); ?>" alt="<?php echo ($rank["title"]); ?>"/>
                                                                <?php else: ?>
                                                                <span class="label label-badge rank-label" title="<?php echo ($rank["title"]); ?>" style="background: <?php echo ($rank["label_bg"]); ?> !important;color:<?php echo ($rank["label_color"]); ?> !important;"><?php echo ($rank["label_content"]); ?></span><?php endif; ?>
                                                        </p>

...
<button type="button" class="<?php echo ((isset($after) && ($after !== ""))?($after):'btn btn-default'); ?>" id="follow" data-after="<?php echo ((isset($before) && ($before !== ""))?($before):'btn btn-default'); ?>"  data-before="<?php echo ((isset($after) && ($after !== ""))?($after):'btn btn-primary'); ?>" data-role="unfollow" data-follow-who="<?php echo ($follow_who); ?>" data-follow-type="1" style="width: 65px;<?php echo ($hide); ?>">

...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div class="all-box" s>
        <form action="/yoyo/index.php?s=/ucenter/member/register.html" method="post" class="lg_lf_form ">
            <div class="login-wrap" style="height: 330px">
                ...
                <div class="clearfix form-group">
                    <div class="col-xs-6" style="padding-left: 0">
                        <label style="color: #848484;font-weight: normal">
                            <a class="l-around" href="<?php echo U('ucenter/member/login');?>">已有账号？点击登录</a>
                        </label>
                    </div>
                ...
                <div class="yes-wrap form-group text-right">
                    <button type="submit" class="login-btn"><?php echo L('_REGISTER_SPACE_');?></button>
                </div>
            </div>
        </form>
    </div>

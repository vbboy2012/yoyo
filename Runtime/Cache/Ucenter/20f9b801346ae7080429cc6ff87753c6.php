...
<script src="/yoyo/Public/js.php?f=js/jquery-2.0.3.min.js,js/com/com.functions.js,static/os-loading/loading.js,js/core.js,js/com/com.toast.class.js,js/com/com.ucard.js"></script>
    ...
    <link href="/yoyo/Application/Ucenter/Static/css/usercenter.css" rel="stylesheet" type="text/css"/>
...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <?php if($user_info['cover_id']): ?><img class="uc_top_img_bg" src="<?php echo ($user_info['cover_path']); ?>" style="width: 100%;height: 100%">
        <?php else: ?>
        <img class="uc_top_img_bg" src="/yoyo/Application/Ucenter/Static/images/user_top_default_bg.jpg" style="width: 100%;height: 100%"><?php endif; ?>
    <?php if(is_login() && $user_info['uid'] == is_login()): ?><div class="change_cover"><a data-type="ajax" data-url="<?php echo U('Ucenter/Public/changeCover');?>" data-toggle="modal" data-title="<?php echo L('_UPLOAD_PERSONAL_COVER_');?>" style="color: white;"><img class="img-responsive" src="/yoyo/Application/Core/Static/images/fractional.png"></a>
        </div><?php endif; ?>
    <div class="avt-wrap">
        ...
        <div class="bottom-wrap row">
            ...
            <?php if(is_login() && $user_info['uid'] != get_uid()): ?><div class="col-xs-4 bt-group">
                ...
                <button type="button" class="btn btn-default" onclick="talker.start_talk(<?php echo ($user_info['uid']); ?>,<?php echo ($has_wukong); ?>)"><?php echo L('_CHAT_');?>
                </button>
            </div><?php endif; ?>
        </div>
    </div>
    ...
    <!-- /.navbar-collapse -->
                ...
                <div class="cont-wrap common-cont-wrap">
                    ...
                    <div class="topic-wrap row">
                        <?php if(is_array($topk)): $i = 0; $__LIST__ = $topk;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="topic-row">
                                <a href="<?php echo U('Weibo/Topic/index',array('topk'=>$vo['id']));?>">
                                    <div class="topk-wrap pull-left">
                                        <div class="pull-left">
                                            <img class="topk-logo"
                                                 src="<?php if($vo["logo"] != 0): echo (getthumbimagebyid($vo["logo"],85,85)); else: ?>/yoyo/Application/Weibo/Static/images/topicavatar.png<?php endif; ?>">
                                        </div>
                                        <div class="topk-info pull-right">
                                            <p class="topk-name"><?php echo ($vo["name"]); ?></p>
                                            <p><?php echo (getshortsp((isset($vo["intro"]) && ($vo["intro"] !== ""))?($vo["intro"]):'导语：推荐话题！',10)); ?></p>
                                            <div class="row">
                                                <span class="pull-lfet topk-read">浏览数:<span>&nbsp;<?php echo ($vo["read_count"]); ?></span></span>
                                                <span class="pull-right topk-weibo">微博数:<span>&nbsp; <?php echo ($vo["weibo_num"]); ?></span></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>

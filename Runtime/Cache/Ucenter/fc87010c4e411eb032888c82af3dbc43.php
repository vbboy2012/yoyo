...
<script src="/yoyo/Public/js.php?f=js/jquery-2.0.3.min.js,js/com/com.functions.js,static/os-loading/loading.js,js/core.js,js/com/com.toast.class.js,js/com/com.ucard.js"></script>
    ...
    <link href="/yoyo/Application/Ucenter/Static/css/new-login.css" type="text/css" rel="stylesheet">
...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div class="all-box">
        <form action="/yoyo/ucenter/member/login.html" method="post" class="lg_lf_form ">
            <div class="login-wrap">
                ...
                <div class="input-box" id="password_block">
                    <input type="password" placeholder="<?php echo L('_NEW_PW_INPUT_');?>" name="password">
                    <i onclick="change_show(this)" class="icon-eye-open open-close"></i>
                </div>
                <!--双重验证码输入-->
                <div id="verify" class="input-box" style="display: none">
                    <input type="text" placeholder="<?php echo L('_GOOGLE_VER_');?>" name="verify">
                </div>
                <div class="clearfix form-group">
                    <div class="col-xs-6" style="padding-left: 0">
                        <label style="color: #848484;font-weight: normal">
                            <a class="l-around" href="<?php echo U('ucenter/member/register');?>">还没注册？点击注册</a>
                        </label>
                    </div>

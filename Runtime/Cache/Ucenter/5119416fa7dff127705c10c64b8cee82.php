                    ...
                    <div class="panel-body">
                        <form class="form-horizontal center_info ajax-form" role="form"
                            ...
                            <div class="form-group">
                                <label for="account" class="col-xs-2 control-label"><?php echo L('_SAFE_PASS_');?></label>

                                <label for="account" class="col-xs-2 control-label" style="text-align: left"><?php echo ($status); ?></label>
                            </div>
                            <div class="form-group">
                                <label for="account" class="col-xs-2 control-label"><?php echo L('_SET_NEW_'); echo L('_PASSWORD_');?></label>
                            ...
                            <div class="form-group">
                                <label for="verify" class="col-xs-2 control-label"><?php echo L('_EMAIL_'); echo L('_VERIFY_CODE_');?></label>
                ...
                <div id="collapseFour" class="panel-collapse collapse col-xs-8">
                    <div class="panel-body">
                        <form class="form-horizontal center_info ajax-form" role="form"
                            ...
                            <div class="form-group">
                                <label for="account" class="col-xs-2 control-label"><?php echo L('_MOBILE_VER_');?></label>
                                <label for="account" class="col-xs-2 control-label" style="text-align: left"><?php echo ($status); ?></label>
                            </div>
                            <div class="form-group">
                                <label for="account" class="col-xs-2 control-label"><?php echo L('_MOBILE_');?></label>
                            ...
                            <div class="form-group">
                                ...
                                <a class="pull-left btn btn-default " data-role="getVerify" style="margin-left: 105px;margin-top: 5px"><?php echo L('_GET_MOBILE_');?></a>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="verify" class="col-xs-2 control-label"><?php echo L('_VERIFY_CODE_');?></label>

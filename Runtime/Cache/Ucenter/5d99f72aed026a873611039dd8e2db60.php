...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div class="v-wrap id-wrap ">
        ...
        <div class="p-wrap">
            <table>
                <?php if($attest['status'] == 1): ?><i class="iconfont icon-yirenzheng yi"></i>
                    <tr>
                        <td class="l-title">当前状态：</td>
                        <td>已通过审核</td>
                    </tr>
                    <?php elseif($attest['status'] == 2): ?>
                    <tr>
                        <td class="l-title">当前状态：</td>
                    ...
                    <tr>
                        ...
                        <td><?php echo ($attest['reason']); ?></td>
                    </tr><?php endif; ?>
                <tr>
                    <td class="l-title">认证类型：</td>
                    <td><?php echo ($attest['type']['title']); ?></td>
                </tr>
                <?php if(($attest["type"]["fields"]["child_type"]) != "0"): ?><tr>
                        <td class="l-title"><span>*</span>认证分类：</td>
                        <td><?php echo ($attest['child_type']); ?></td>
                    </tr><?php endif; ?>
                <?php if(($attest["type"]["fields"]["company_name"]) != "0"): ?><tr>
                        <td class="l-title">
                            <?php if(($attest["type"]["fields"]["company_name"]) == "1"): ?><span>*</span><?php endif; ?>
                            <?php if(($attest["type"]["name"]) == "company"): ?>企业<?php else: ?>组织机构<?php endif; ?>名称：
                        </td>
                        <td><?php echo ($attest['company_name']); ?></td>
                    </tr><?php endif; ?>
                <?php if(($attest["type"]["fields"]["name"]) != "0"): ?><tr>
                        <td class="l-title">
                            <?php if(($attest["type"]["fields"]["name"]) == "1"): ?><span>*</span><?php endif; ?>
                            真实姓名：
                        </td>
                        <td><?php echo ($attest['name']); ?></td>
                    </tr><?php endif; ?>
                <?php if(($attest["type"]["fields"]["id_num"]) != "0"): ?><tr>
                        <td class="l-title">
                            <?php if(($attest["type"]["fields"]["id_num"]) == "1"): ?><span>*</span><?php endif; ?>
                            身份证号码：
                        </td>
                        <td><?php echo ($attest['id_num']); ?></td>
                    </tr><?php endif; ?>
                <?php if(($attest["type"]["fields"]["phone"]) != "0"): ?><tr>
                        <td class="l-title">
                            <?php if(($attest["type"]["fields"]["phone"]) == "1"): ?><span>*</span><?php endif; ?>
                            联系方式：
                        </td>
                        <td><?php echo ($attest['phone']); ?></td>
                    </tr><?php endif; ?>
                <?php if(($attest["type"]["fields"]["image_type"]) != "0"): ?><tr>
                        <td class="l-title">
                            <?php if(($attest["type"]["fields"]["image_type"]) == "1"): ?><span>*</span><?php endif; ?>
                            证件类型：
                        </td>
                        <td><?php echo ($attest['image_type']); ?></td>
                    </tr><?php endif; ?>
                <?php if(($attest["type"]["fields"]["prove_image"]) != "0"): ?><tr>
                        <td class="l-title">
                            <?php if(($attest["type"]["fields"]["prove_image"]) == "1"): ?><span>*</span><?php endif; ?>
                            <?php if(($attest["type"]["name"]) == "company"): ?>企业<?php else: ?>组织机构<?php endif; ?>证件：
                        </td>
                        <td class="image-list">
                            <?php if(is_array($attest["prove_image"])): $i = 0; $__LIST__ = $attest["prove_image"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$one_prove_image): $mod = ($i % 2 );++$i;?><img src="<?php echo (get_cover($one_prove_image,'path')); ?>"/><?php endforeach; endif; else: echo "" ;endif; ?>
                        </td>
                    </tr><?php endif; ?>
                <?php if(($attest["type"]["fields"]["image"]) != "0"): ?><tr>
                        <td class="l-title">
                            <?php if(($attest["type"]["fields"]["image"]) == "1"): ?><span>*</span><?php endif; ?>
                            证件正反面照：
                        </td>
                        <td class="image-list">
                            <?php if(is_array($attest["image"])): $i = 0; $__LIST__ = $attest["image"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$one_image): $mod = ($i % 2 );++$i;?><img src="<?php echo (get_cover($one_image,'path')); ?>"/><?php endforeach; endif; else: echo "" ;endif; ?>
                        </td>
                    </tr><?php endif; ?>
                <?php if(($attest["type"]["fields"]["other_image"]) != "0"): ?><tr>
                        <td class="l-title">
                            <?php if(($attest["type"]["fields"]["other_image"]) == "1"): ?><span>*</span><?php endif; ?>
                            其他证明材料：
                        </td>
                        <td class="image-list">
                            <?php if(is_array($attest["other_image"])): $i = 0; $__LIST__ = $attest["other_image"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$one_other_image): $mod = ($i % 2 );++$i;?><img src="<?php echo (get_cover($one_other_image,'path')); ?>"/><?php endforeach; endif; else: echo "" ;endif; ?>
                        </td>
                    </tr><?php endif; ?>
                <?php if(($attest["type"]["fields"]["info"]) != "0"): ?><tr>
                        <td class="l-title">
                            <?php if(($attest["type"]["fields"]["info"]) == "1"): ?><span>*</span><?php endif; ?>
                            认证补充：
                        </td>
                        <td><?php echo ($attest['info']); ?></td>
                    </tr><?php endif; ?>
                <?php if($attest['status'] == 1): ?><tr class="b-group">
                        <td>
                            <a href="<?php echo U('Ucenter/Attest/deleteApply',array('id'=>$attest['id']));?>" class="a-btn">注销认证</a>
                            <a href="<?php echo U('Ucenter/Attest/index');?>" class="a-btn" style="background-color: #cccccc;">认证中心</a>
                        </td>
                    </tr>
                    <?php else: ?>
                    <tr class="b-group">
                        <td>
                            <a href="<?php echo U('Ucenter/Attest/apply',array('change'=>1));?>" class="a-btn">修改认证资料</a>
                            <a href="<?php echo U('Ucenter/Attest/deleteApply',array('id'=>$attest['id']));?>" class="a-btn">取消认证</a>
                            <a href="<?php echo U('Ucenter/Attest/index');?>" class="a-btn" style="background-color: #cccccc;">认证中心</a>
                        </td>
                    </tr><?php endif; ?>
            </table>

        ...
        <div id="center_base" class="with-padding" style="padding: 20px">
            ...
            <div class="row">
                ...
                <div class="with-padding">
                    <button data-role="cleanRemember" class="btn btn-large btn-block btn-primary" type="button"><?php echo L('_LOGIN_RECORD_CLEAR_');?>
                    </button>
    ...
    <script>
        ...
        $(function () {
            $('[data-role=cleanRemember]').click(function () {
                if (confirm("<?php echo L('_LOGIN_RECORD_CLEAR__CONFIRM_'); echo L('_EXCLAMATION_');?>")) {

...
<script src="/yoyo/Public/js.php?f=js/jquery-2.0.3.min.js,js/com/com.functions.js,static/os-loading/loading.js,js/core.js,js/com/com.toast.class.js,js/com/com.ucard.js"></script>
    ...
    <link href="/yoyo/Application/Ucenter/Static/css/ad.css" rel="stylesheet" type="text/css"/>
...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div class="col-xs-12 usercenter">
        <div class="uc">
            <div class="uc-cont">
                <div class="col-xs-2">
                    <?php if(ACTION_NAME=='myad'){ $tabClass['ad'] = 'active'; } elseif(ACTION_NAME=='myorder'){ $tabClass['myorder'] = 'active'; } else{ $tabClass[$type] = 'active'; } ?>
...
<nav class="navbar navbar-default uc_navbar" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav new-nav">
            <li>
                <a href="<?php echo U('ucenter/index/myad');?>" class="<?php echo ($tabClass["ad"]); ?>">我的广告</a>
                <a href="<?php echo U('ucenter/index/myorder');?>" class="<?php echo ($tabClass["myorder"]); ?>">我的交易</a>
            </li>
    ...
    <!-- /.navbar-collapse -->
                ...
                <div class="col-xs-10 common-cont-wrap">
                    <div id="center_account">
                        <div class="row">
                            <div class="col-xs-12">
                                <ul class="nav nav-secondary">
                                    <li class="<?php echo $active==1?"active":""; ?>"><a href="#tab_1" data-toggle="tab"><?php echo L('_MY_TRADE_NOW_');?></a></li>
                                    <li class="<?php echo $active==2?"active":""; ?>"><a href="#tab_2" data-toggle="tab"><?php echo L('_MY_TRADE_SUCCESS_');?></a></li>
                                    <li class="<?php echo $active==3?"active":""; ?>"><a href="#tab_3" data-toggle="tab"><?php echo L('_MY_TRADE_CANCEL_');?></a></li>
                                    <li class="<?php echo $active==4?"active":""; ?>"><a href="#tab_4" data-toggle="tab"><?php echo L('_MY_TRADE_QUESTION_');?></a></li>
                                </ul>

                            </div>
                        </div>
                        <div class="tab-content">
                            <div class="tab-pane <?php echo $active==1?"active":""; ?>" id="tab_1">
                            <?php if(count($orderList1) == 0): ?><p class="text-muted"
                                                                       style="text-align: center; font-size: 3em;">
                                <br><br>
                                <?php echo L('_ORDER_NONE_'); echo L('_WAVE_');?>
                                <br><br><br>
                            </p>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                    <?php if(is_array($orderList1)): $i = 0; $__LIST__ = $orderList1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <?php $price = number_format($vo['price'],2); if($vo['type'] == 1){ $type = '在线出售'; }else if($vo['type'] == 2){ $type = '在线购买'; }else if($vo['type'] == 3){ $type = '本地出售'; }else if($vo['type'] == 4){ $type = '本地购买'; } $coinType = $vo['coin_type'] == 1 ? 'BTC':'ETH'; $time = date('Y-m-d H:i:s', $vo['create_time']); if($vo['status'] == 1){ $status = '待付款'; }else if($vo['status'] == 2){ $status = '已付款'; } $trade_uid = $vo['ad_uid'] == get_uid()?$vo['get_uid']:$vo['ad_uid']; $userInfo = query_user(array('nickname'), $trade_uid); ?>
                                            <td style="vertical-align: middle;"><a href="/yoyo/order/<?php echo ($vo["order_id"]); ?>"><?php echo ($vo["order_id"]); ?></a></td>
                                            <td style="vertical-align: middle;"><?php echo ($time); ?></td>
                                            <td style="vertical-align: middle;"><?php echo ($coinType); ?></td>
                                            <td style="vertical-align: middle"><?php echo ($type); ?></td>
                                            <td style="vertical-align: middle"><a href="/yoyo/ucenter/following/<?php echo ($trade_uid); ?>"><?php echo ($userInfo["nickname"]); ?></a></td>
                                            <td style="vertical-align: middle;color: #0C7F12"><b><?php echo ($vo["coin_num"]); ?></b></td>
                                            <td style="vertical-align: middle"><?php echo ($vo["trade_price"]); ?> <?php echo ($vo["currency"]); ?></td>
                                            <td style="vertical-align: middle"><?php echo ($vo["fee"]); ?></td>
                                            <td style="vertical-align: middle"><?php echo ($status); ?></td>
                                            <td style="vertical-align: middle"><a href="/yoyo/order/<?php echo ($vo["order_id"]); ?>">查看留言</a></td>
                                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </tbody>
                                </table><?php endif; ?>
                            <?php if($pages1 > 1): ?><ul class="pager" style="float: right">
                                    <?php $previous = $page1-1;$previous = $previous==0?1:$previous; $next = $page1+1;$next = $next==$pages1?$next-1:$next; ?>
                                    <li class="previous"><a href="?page1=<?php echo ($previous); ?>"><</a></li>
                                    <?php $__FOR_START_205165750__=1;$__FOR_END_205165750__=$pages1;for($i=$__FOR_START_205165750__;$i < $__FOR_END_205165750__;$i+=1){ ?><li class="<?php echo $page1==$i?"active":""; ?>"><a href="?page1=<?php echo ($i); ?>"><?php echo ($i); ?></a></li><?php } ?>
                                    </volist>
                                    <li class="next"><a href="?page1=<?php echo ($next); ?>">></a></li>
                                </ul><?php endif; ?>
                        </div>
                        <div class="tab-pane <?php echo $active==2?"active":""; ?>" id="tab_2">
                        <?php if(count($orderList2) == 0): ?><p class="text-muted"
                                                                   style="text-align: center; font-size: 3em;">
                            <br><br>
                            <?php echo L('_ORDER_NONE_'); echo L('_WAVE_');?>
                            <br><br><br>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                <?php if(is_array($orderList2)): $i = 0; $__LIST__ = $orderList2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <?php $price = number_format($vo['price'],2); if($vo['type'] == 1){ $type = '在线出售'; }else if($vo['type'] == 2){ $type = '在线购买'; }else if($vo['type'] == 3){ $type = '本地出售'; }else if($vo['type'] == 4){ $type = '本地购买'; } $coinType = $vo['coin_type'] == 1 ? 'BTC':'ETH'; $time = date('Y-m-d H:i:s', $vo['create_time']); $status = '已完成'; $trade_uid = $vo['ad_uid'] == get_uid()?$vo['get_uid']:$vo['ad_uid']; $userInfo = query_user(array('nickname'), $trade_uid); ?>
                                        <td style="vertical-align: middle;"><a href="/yoyo/order/<?php echo ($vo["order_id"]); ?>"><?php echo ($vo["order_id"]); ?></a></td>
                                        <td style="vertical-align: middle;"><?php echo ($time); ?></td>
                                        <td style="vertical-align: middle;"><?php echo ($coinType); ?></td>
                                        <td style="vertical-align: middle"><?php echo ($type); ?></td>
                                        <td style="vertical-align: middle"><a href="/yoyo/user/<?php echo ($trade_uid); ?>"><?php echo ($userInfo["nickname"]); ?></a></td>
                                        <td style="vertical-align: middle;color: #0C7F12"><b><?php echo ($vo["coin_num"]); ?></b></td>
                                        <td style="vertical-align: middle"><?php echo ($price); ?> <?php echo ($vo["currency"]); ?></td>
                                        <td style="vertical-align: middle"><?php echo ($vo["fee"]); ?></td>
                                        <td style="vertical-align: middle"><?php echo ($status); ?></td>
                                        <td style="vertical-align: middle"><a href="/yoyo/order/<?php echo ($vo["order_id"]); ?>">查看留言</a></td>
                                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <?php if($pages2 > 1): ?><ul class="pager" style="float: right">
                                <?php $previous = $page2-1;$previous = $previous==0?1:$previous; $next = $page2+1;$next = $next==$pages2?$next-1:$next; ?>
                                <li class="previous"><a href="?page2=<?php echo ($previous); ?>"><</a></li>
                                <?php $__FOR_START_1041545182__=1;$__FOR_END_1041545182__=$pages2;for($i=$__FOR_START_1041545182__;$i < $__FOR_END_1041545182__;$i+=1){ ?><li class="<?php echo $page2==$i?"active":""; ?>"><a href="?page2=<?php echo ($i); ?>"><?php echo ($i); ?></a></li><?php } ?>
                                </volist>
                                <li class="next"><a href="?page2=<?php echo ($next); ?>">></a></li>
                            </ul><?php endif; ?>
                    </div>
                    <div class="tab-pane <?php echo $active==3?"active":""; ?>" id="tab_3">
                    <?php if(count($orderList3) == 0): ?><p class="text-muted"
                                                               style="text-align: center; font-size: 3em;">
                        <br><br>
                        <?php echo L('_ORDER_NONE_'); echo L('_WAVE_');?>
                        <br><br><br>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($orderList3)): $i = 0; $__LIST__ = $orderList3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <?php $price = number_format($vo['price'],2); if($vo['type'] == 1){ $type = '在线出售'; }else if($vo['type'] == 2){ $type = '在线购买'; }else if($vo['type'] == 3){ $type = '本地出售'; }else if($vo['type'] == 4){ $type = '本地购买'; } $coinType = $vo['coin_type'] == 1 ? 'BTC':'ETH'; $time = date('Y-m-d H:i:s', $vo['create_time']); $status = '已取消'; $trade_uid = $vo['ad_uid'] == get_uid()?$vo['get_uid']:$vo['ad_uid']; $userInfo = query_user(array('nickname'), $trade_uid); ?>
                                    <td style="vertical-align: middle;"><a href="/yoyo/order/<?php echo ($vo["order_id"]); ?>"><?php echo ($vo["order_id"]); ?></a></td>
                                    <td style="vertical-align: middle;"><?php echo ($time); ?></td>
                                    <td style="vertical-align: middle;"><?php echo ($coinType); ?></td>
                                    <td style="vertical-align: middle"><?php echo ($type); ?></td>
                    ...
                    <?php if($pages3 > 1): ?><ul class="pager" style="float: right">
                            <?php $previous = $page3-1;$previous = $previous==0?1:$previous; $next = $page3+1;$next = $next==$pages3?$next-1:$next; ?>
                            <li class="previous"><a href="?page3=<?php echo ($previous); ?>"><</a></li>
                            <?php $__FOR_START_1334998116__=1;$__FOR_END_1334998116__=$pages3;for($i=$__FOR_START_1334998116__;$i < $__FOR_END_1334998116__;$i+=1){ ?><li class="<?php echo $page3==$i?"active":""; ?>"><a href="?page3=<?php echo ($i); ?>"><?php echo ($i); ?></a></li><?php } ?>
                            </volist>
                            <li class="next"><a href="?page3=<?php echo ($next); ?>">></a></li>
                        </ul><?php endif; ?>
                </div>
                <div class="tab-pane <?php echo $active==4?"active":""; ?>" id="tab_4">
                <?php if(count($orderList4) == 0): ?><p class="text-muted"
                                                           style="text-align: center; font-size: 3em;">
                    <br><br>
                    <?php echo L('_ORDER_NONE_'); echo L('_WAVE_');?>
                    <br><br><br>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                        <?php if(is_array($orderList4)): $i = 0; $__LIST__ = $orderList4;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <?php $price = number_format($vo['price'],2); if($vo['type'] == 1){ $type = '在线出售'; }else if($vo['type'] == 2){ $type = '在线购买'; }else if($vo['type'] == 3){ $type = '本地出售'; }else if($vo['type'] == 4){ $type = '本地购买'; } $coinType = $vo['coin_type'] == 1 ? 'BTC':'ETH'; $time = date('Y-m-d H:i:s', $vo['create_time']); $status = '申诉中'; $trade_uid = $vo['ad_uid'] == get_uid()?$vo['get_uid']:$vo['ad_uid']; $userInfo = query_user(array('nickname'), $trade_uid); ?>
                                <td style="vertical-align: middle;"><a href="/yoyo/order/<?php echo ($vo["order_id"]); ?>"><?php echo ($vo["order_id"]); ?></a></td>
                                <td style="vertical-align: middle;"><?php echo ($time); ?></td>
                                <td style="vertical-align: middle;"><?php echo ($coinType); ?></td>
                                <td style="vertical-align: middle"><?php echo ($type); ?></td>
                ...
                <?php if($pages4 > 1): ?><ul class="pager" style="float: right">
                        <?php $previous = $page4-1;$previous = $previous==0?1:$previous; $next = $page4+1;$next = $next==$pages4?$next-1:$next; ?>
                        <li class="previous"><a href="?page4=<?php echo ($previous); ?>"><</a></li>
                        <?php $__FOR_START_2101747111__=1;$__FOR_END_2101747111__=$pages4;for($i=$__FOR_START_2101747111__;$i < $__FOR_END_2101747111__;$i+=1){ ?><li class="<?php echo $page4==$i?"active":""; ?>"><a href="?page4=<?php echo ($i); ?>"><?php echo ($i); ?></a></li><?php } ?>
                        </volist>
                        <li class="next"><a href="?page4=<?php echo ($next); ?>">></a></li>
                    </ul><?php endif; ?>
            </div>
        </div>
    </div>

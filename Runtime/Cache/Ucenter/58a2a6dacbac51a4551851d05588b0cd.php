                    ...
                    <div id="center_account">
                        <div class="row">
                            <div class="col-xs-12">
                                <ul class="nav nav-secondary">
                                    <li class="active"><a href="#tab_1" data-toggle="tab"><?php echo L('_MY_TRADE_NOW_');?></a></li>
                                    <li><a href="#tab_2" data-toggle="tab"><?php echo L('_MY_TRADE_SUCCESS_');?></a></li>
                                    <li><a href="#tab_3" data-toggle="tab"><?php echo L('_MY_TRADE_CANCEL_');?></a></li>
                                    <li><a href="#tab_4" data-toggle="tab"><?php echo L('_MY_TRADE_QUESTION_');?></a></li>
                                </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_3">
                                <?php if(count($orderList0) == 0): ?><p class="text-muted"
                                                                           style="text-align: center; font-size: 3em;">
                                    <br><br>
                                    <?php echo L('_ORDER_NONE_'); echo L('_WAVE_');?>
                                    <br><br><br>
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                        <?php if(is_array($orderList0)): $i = 0; $__LIST__ = $orderList0;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                <?php $price = number_format($vo['price'],2); if($vo['type'] == 1){ $type = '在线出售'; }else if($vo['type'] == 2){ $type = '在线购买'; }else if($vo['type'] == 3){ $type = '本地出售'; }else if($vo['type'] == 4){ $type = '本地购买'; } $coinType = $vo['coin_type'] == 1 ? 'BTC':'ETH'; $time = date('Y-m-d H:i:s', $vo['create_time']); if($vo['status'] == 1){ $status = '待付款'; }else if($vo['status'] == 2){ $status = '已付款'; }else if($vo['status'] == 3){ $status = '已完成'; }else if($vo['status'] == 4){ $status = '申诉中'; }else if($vo['status'] == 0){ $status = '已取消'; } $trade_uid = $vo['ad_uid'] == get_uid()?$vo['get_uid']:$vo['ad_uid']; $userInfo = query_user(array('nickname'), $trade_uid); ?>
                                                <td style="vertical-align: middle;"><a href="/yoyo/order/<?php echo ($vo["order_id"]); ?>"><?php echo ($vo["order_id"]); ?></a></td>
                                                <td style="vertical-align: middle;"><?php echo ($time); ?></td>
                                                <td style="vertical-align: middle;"><?php echo ($coinType); ?></td>

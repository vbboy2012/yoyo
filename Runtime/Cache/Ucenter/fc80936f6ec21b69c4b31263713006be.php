...
<script src="/yoyo/Public/js.php?f=js/jquery-2.0.3.min.js,js/com/com.functions.js,static/os-loading/loading.js,js/core.js,js/com/com.toast.class.js,js/com/com.ucard.js"></script>
    ...
    <link href="/yoyo/Application/Ucenter/Static/css/rank.css" rel="stylesheet" type="text/css"/>
                    ...
                    <div class="row">
                        <div class="col-xs-12 uc_fans" style="margin-left: 10px;">
                            <ul class="nav nav-pills ucenter-tab">
                                <li <?php if(($tab) == "rank"): ?>class="active"<?php endif; ?>><a href="<?php echo U('Ucenter/Config/rank',array('uid'=>$uid));?>"

                            >
                                <?php echo L('_TANK_OWNED_');?></a></li>
                                <li <?php if(($tab) == "rankVerifyWait"): ?>class="active"<?php endif; ?>><a href="<?php echo U('Ucenter/Config/rankVerifyWait');?>"

                            >
                                <?php echo L('_RANK_WAIT_AUDIT_');?></a></li>
                                <li <?php if(($tab) == "rankVerifyFailure"): ?>class="active"<?php endif; ?>><a href="<?php echo U('Ucenter/Config/rankVerifyFailure');?>"

                            >
                                <?php echo L('_RANK_APPLY_FAILED_');?></a></li>
                                <li <?php if(($tab) == "rankVerify"): ?>class="active"<?php endif; ?>><a href="<?php echo U('Ucenter/Config/rankVerify');?>"
                    ...
                    <?php if(count($rankList) == 0): ?><p class="text-muted"
                        ...
                        <div style="margin: 20px 0 20px 20px;">
                            <form class="form-horizontal center_info ajax-form" role="form"
                                  action="<?php echo U('Ucenter/Config/verifyy');?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-10">
                                        <textarea id="reason" name="reason" class="form-control"
                                                  style="width: 80%; height: 6em;resize: none"><?php echo ($old_rank_user['reason']); ?></textarea>
                                    </div>
                                </div>

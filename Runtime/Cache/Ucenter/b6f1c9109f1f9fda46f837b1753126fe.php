                    ...
                    <div class="row">
                        <div class="col-xs-12 uc_fans">
                            <ul class="nav nav-pills ucenter-tab">
                                <li <?php if(($tab) == "rank"): ?>class="active"<?php endif; ?>><a href="<?php echo U('Ucenter/Index/rank',array('uid'=>$user_info['uid']));?>"

                            >
                                <?php echo L('_TANK_OWNED_');?></a></li>
                                <?php if($user_info['uid'] == is_login()): ?><li <?php if(($tab) == "rankVerifyWait"): ?>class="active"<?php endif; ?>><a href="<?php echo U('Ucenter/Index/rankVerifyWait');?>"

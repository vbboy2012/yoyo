...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div id="center">
        <div id="center_base" class="with-padding" style="padding: 20px">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <form id="setShortUrl"  action="<?php echo U('Ucenter/Config/shortUrl');?>" method="post" class="ajax-form form-horizontal">
                        <input type="hidden" name="id" value="<?php echo ($shortUrl['id']); ?>">
                        <div class="form-group">
                            <label  class="col-xs-3 control-label">当前个性域名：</label>
                            <div class="col-xs-8">
                                <?php if(!empty($shortUrl["short"])): ?><label style="line-height: 30px;"><?php echo ($base_url); echo ($shortUrl['short']); ?></label><?php endif; ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="short" class="col-xs-3 control-label">设置个性域名：</label>
                            <div class="col-xs-8">
                                <div><?php echo ($base_url); ?><input type="text" class="form-control" id="short" style="width: 50%;display: inline-block;" value="<?php echo ($shortUrl['short']); ?>" name="short" placeholder="请输入个性域名"></div>
                                <div class="tip">个性域名只能由4-20个字母或数字组成！</div>
                            </div>
                        </div>
                        <div class="form-group">

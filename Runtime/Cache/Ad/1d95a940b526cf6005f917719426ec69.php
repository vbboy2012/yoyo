                ...
                <div style="padding: 0 10px;width: 100%;float: left;">
                    <form class="form-horizontal ajax-form" action="<?php echo U('Ad/Index/doPost');?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <label> <input name="coin_type" value="1" type="radio" <?php if($ad['type'] == '1'): ?>checked<?php endif; ?>/>BTC</label>
                                <label class="ad_magrain40"> <input name="coin_type" value="2" type="radio" <?php if($ad['type'] == '2'): ?>checked<?php endif; ?>/>ETH</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <div class="input-group input-group-lg">
                                    <input type="text" class="form-control form_check" value="<?php echo ($ad['pre_price']); ?>" name="pre_price" check-type="IntNum">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <textarea name="pay_text" class="text form-control" placeholder="<?php echo L('_AD_PAY_TEXT_TIPS_LABEL_');?>" style="height: 8em;height: 160px"><?php echo ($ad['pay_text1']); ?></textarea>
                            </div>
                        </div>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="start_time7" class="form-control ">
                                            <option value="00.00" <?php if($openTime->st7 == '00.00'): ?>selected<?php endif; ?>>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="end_time7" class="form-control ">
                                            <option value="24.00" <?php if($openTime->et7 == '24.00'): ?>selected<?php endif; ?>>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="start_time1" class="form-control ">
                                            <option value="00.00" <?php if($openTime->st1 == '00.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_START_TIME_');?>
                                            </option>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="end_time1" class="form-control ">
                                            <option value="24.00" <?php if($openTime->et1 == '24.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_END_TIME_');?>
                                            </option>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="start_time2" class="form-control ">
                                            <option value="00.00" <?php if($openTime->st2 == '00.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_START_TIME_');?>
                                            </option>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="end_time2" class="form-control ">
                                            <option value="24.00" <?php if($openTime->et2 == '24.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_END_TIME_');?>
                                            </option>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="start_time3" class="form-control ">
                                            <option value="00.00" <?php if($openTime->st3 == '00.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_START_TIME_');?>
                                            </option>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="end_time3" class="form-control ">
                                            <option value="24.00" <?php if($openTime->et3 == '24.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_END_TIME_');?>
                                            </option>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="start_time4" class="form-control ">
                                            <option value="00.00" <?php if($openTime->st4 == '00.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_START_TIME_');?>
                                            </option>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="end_time4" class="form-control ">
                                            <option value="24.00" <?php if($openTime->et4 == '24.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_END_TIME_');?>
                                            </option>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="start_time5" class="form-control ">
                                            <option value="00.00" <?php if($openTime->st5 == '00.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_START_TIME_');?>
                                            </option>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="end_time5" class="form-control ">
                                            <option value="24.00" <?php if($openTime->et5 == '24.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_END_TIME_');?>
                                            </option>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="start_time6" class="form-control ">
                                            <option value="00.00" <?php if($openTime->st6 == '00.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_START_TIME_');?>
                                            </option>
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-lg">
                                        <select name="end_time6" class="form-control ">
                                            <option value="24" <?php if($openTime->et6 == '24.00'): ?>selected<?php endif; ?>>
                                            <?php echo L('_END_TIME_');?>
                                            </option>

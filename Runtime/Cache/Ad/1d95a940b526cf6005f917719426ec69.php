                ...
                <div style="padding: 0 10px;width: 100%;float: left;">
                    <form class="form-horizontal ajax-form" action="<?php echo U('Ad/Index/doPost');?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <textarea name="pay_text" class="text form-control" placeholder="<?php echo L('_AD_PAY_TEXT_TIPS_LABEL_');?>" style="height: 8em;height: 160px"><?php echo ($ad['pay_text']); ?></textarea>
                            </div>
                        </div>

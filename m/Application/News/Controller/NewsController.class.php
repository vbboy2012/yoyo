   ...
   /* public function config()
    {
        ...
        $builder->keyRadio('NEWS_ORDER_FIELD',L('_FRONT_LIST_SORT_'),L('_SORT_RULE_'),array('view'=>L('_VIEWS_'),'create_time'=>L('_CREATE_TIME_'),'update_time'=>L('_UPDATE_TIME_')))->keyDefault('NEWS_ORDER_FIELD','create_time')
            ...
            ->group(L('_BASIC_CONF_'), 'NEWS_ORDER_FIELD,NEWS_ORDER_TYPE,NEWS_PAGE_NUM')

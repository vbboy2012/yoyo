...
class EventController extends AdminController
{
    ...
    public function config()
    {
        ...
        $admin_config->title(L('_EVENT_BASIC_CONF_'))->data($data)
            ...
            ->keyTextArea('EVENT_TIP_TENDER', L('_EVENT_DETAIL_').L('_TIP_TENDER_'))->keyDefault('EVENT_TIP_TENDER','• 参与凭证：提交报名后活动发起人同意即可参与\n• 费用说明：请详见活动详情')
            ...
            ->group(L('_EVENT_BASIC_CONF_'),'NEED_VERIFY,SHENHE_SEND_WEIBO,EVENT_TIP_TENDER')->group(L('_HOME_SHOW_CONF_'), 'EVENT_SHOW_COUNT,EVENT_SHOW_TITLE,EVENT_SHOW_TYPE,EVENT_SHOW_ORDER_TYPE,EVENT_SHOW_ORDER_FIELD,EVENT_SHOW_CACHE_TIME')

...
class AuthGroupModel extends Model {
    ...
    protected $tableName = 'm_auth_group';

    const TYPE_ADMIN                = 1;                   // 管理员权限组类型标识
    const MEMBER                    = 'member';
    const UCENTER_MEMBER            = 'ucenter_member';
    const AUTH_GROUP_ACCESS         = 'm_auth_group_access'; // 关系表表名
    const AUTH_EXTEND               = 'm_auth_extend';       // 动态权限扩展信息表
    const AUTH_GROUP                = 'm_auth_group';        // 权限组表名

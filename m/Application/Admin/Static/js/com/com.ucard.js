                ...
                $.get(U('Ucenter/Public/getProfile'), {uid: uid}, function (userProfile) {
                    ...
                    if ((MID != uid) && (MID != 0)) {
                        ...
                        if (userProfile.followed == 1) {
                            follow += '<button type="button" class="btn btn-default" data-role="unfollow" data-follow-who="'+userProfile.uid+'"  style="float: right;margin: 5px 0;padding: 2px 12px;"><font title="取消信任">已信任</font></button>';
                        } else {
                    ...
                    var html = '<div class="row" style="width: 350px;width: 350px;font-size: 13px;line-height: 23px;">' +
                        ...
                        '</div>' +
                        '<div>' +
                        '<a href="{$userProfile.following_url}" title="我的信任" target="_black">信任：{$userProfile.following}</a>&nbsp;&nbsp;&nbsp;&nbsp;' +
                        '<a href="{$userProfile.fans_url}" title="我的信任" target="_black">粉丝：{$userProfile.fans}</a>&nbsp;&nbsp;&nbsp;&nbsp;' +
                        '</div>' +

<?php
namespace Weixin\Builder;
use Admin\Builder\AdminBuilder;

class WeixinMenuBuilder extends AdminBuilder{
    ...
    public function display()
    {
        ...
        $this->view->display('Weixin@Admin/admin_tree');
    }
    ...
    public function tree($tree = null)
    {
        ...
        $this->view->display('Weixin@Admin/tree');
    }

...
class VideoController extends AddonsController{
    public function getVideoInfo()
    {
        ...
        if (preg_match("/(youku.com|ku6.com|sohu.com|sina.com.cn|qq.com|tudou.com|yinyuetai.com|iqiyi.com|bilibili.com)/i", $link, $hosts)) {
            $return['boolen'] = 1;
            $return['data'] = $link;
        } else {
            $return['boolen'] = 0;
            $return['message'] = '仅支持优酷、酷6、新浪、土豆网、搜狐、音悦台、腾讯、爱奇艺、哔哩哔哩等视频发布';
        }

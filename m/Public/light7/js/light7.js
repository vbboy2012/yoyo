...
+function ($) {
  "use strict";
    ...
    $.modal = function (params) {
        params = params || {};
        params.zidiyi = params.zidiyi || '';
        params.zdywrap = params.zdywrap || '';
        params.myfather = params.myfather || '';
        var modalHTML = '';
        if (defaults.modalTemplate) {
            ...
            if (params.buttons && params.buttons.length > 0) {
                for (var i = 0; i < params.buttons.length; i++) {
                    buttonsHTML += '<span class="modal-button '+ params.zidiyi + (params.buttons[i].bold ? ' modal-button-bold' : '') + '">' + params.buttons[i].text + '</span>';
                }
            }
            ...
            modalHTML = '<div class="' +params.myfather+' modal ' + noButtons + '"><div class="modal-inner ' +params.zdywrap+'">' + (titleHTML + textHTML + afterTextHTML) + '</div><div class="modal-buttons ' + verticalButtons + '">' + buttonsHTML + '</div></div>';
        }
